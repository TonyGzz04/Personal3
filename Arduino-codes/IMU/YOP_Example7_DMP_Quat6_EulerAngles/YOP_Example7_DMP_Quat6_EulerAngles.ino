...
void setup()
{
  ...
  if (success) {Serial.println("initialize DMP 111");}
  success &= (myICM.initializeDMP() == ICM_20948_Stat_Ok);
  if (success) {Serial.println("initialize DMP");}
  ...
  if (success) {Serial.println("enable DMP");}
  ...
  if (success) {Serial.println("set DMP");}
  ...
  if (success) {Serial.println("enable FIFO");}

  // Enable the DMP
  success &= (myICM.enableDMP() == ICM_20948_Stat_Ok);
  if (success) {Serial.println("enable DMP 2");}

  // Reset DMP
  success &= (myICM.resetDMP() == ICM_20948_Stat_Ok);
  if (success) {Serial.println("reset DMP");}

  // Reset FIFO
  success &= (myICM.resetFIFO() == ICM_20948_Stat_Ok);
  if (success) {Serial.println("reset FIFO");}
