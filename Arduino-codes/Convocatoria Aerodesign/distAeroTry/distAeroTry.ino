...
void loop() 
{
  ...
  if (ICM_found)
  {
    ...
    delay(10); icm20948.task();
    run_icm20948_gyro_controller(); delay(10); icm20948.task();
    Serial.print(0); Serial.print(",");
    Serial.print(0); Serial.print(",");
    Serial.print(0); Serial.print(",");
    run_icm20948_quat9_controller(true); delay(10); icm20948.task();
    run_icm20948_accel_controller(); delay(10);
