...
*/
    ...
    pinMode(LED_PIN, OUTPUT);
     ...
     while (gradosInicial==0){
 gradosInicial=nose(0);
  }

 Serial.print("GRADOSINICIAL: ");
 Serial.println(gradosInicial);
...
time1=millis();
 if (gradosInicial>=0){
  while (grados>=(90-gradosInicial)*-1){
    ...
    grados=nose(0);
    /*
    //gradosTotal=gradosInicial-grados;
    Serial.print("GRADOSTOTAL: ");
    Serial.println(grados-gradosInicial);
